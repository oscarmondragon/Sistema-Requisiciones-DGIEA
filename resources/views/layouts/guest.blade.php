        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 fondo_degradado shadow-md overflow-hidden sm:rounded-lg">
            <div class="con">
                <a href="/">
                    ...
                    <img src="{{ 'img/logo_login.png' }}" alt="Image/png"
