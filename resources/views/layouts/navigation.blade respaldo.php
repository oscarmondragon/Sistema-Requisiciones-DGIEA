<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('adquisiciones.index')" :active="request()->routeIs('adquisiciones.index')">
                        {{ __('Adquisiciones') }}
                    </x-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
                ...
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('seguimiento.index')" :active="request()->routeIs('seguimiento.index')">
                        {{ __('SIIA') }}
                    </x-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
