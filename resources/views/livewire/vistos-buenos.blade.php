              ...
              <div class="p-6 overflow-x-auto">
                ...
                <table class="table-auto text-left text-sm w-3/4 sm:w-full mx-auto mt-6">
                  ...
                  @foreach ($adquisiciones as $adquisicion=>$valor)                   
                      ...
                      @else
                      <td>
                       <a href="{{route('solicitudes.editar', $valor->id)}}"  title="Editar">
                        <button class="btn-tablas" title="Editar">
                ...
                <table class="table-auto text-left text-sm w-3/4 sm:w-full mx-auto mt-6">
                  ...
                  <tbody>
                    ...
                    <tr class="border-b-gray-200 border-transparent">
                      ...
                      <td> {{ $valorvobo->vobo_rt ?? 'Pendiente' }} </td>
                      <td> {{ $valorvobo->vobo_admin ?? 'Pendiente'}} </td>
                      <td><span class="block mx-4 bg-btn_vobo rounded-full p-1 px-2 text-center text-white font-bold">
                        {{$valorvobo->estado}}
                    </span></td>
