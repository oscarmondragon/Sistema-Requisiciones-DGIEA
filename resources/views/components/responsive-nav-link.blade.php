...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-dorado text-left text-base font-medium text-textos_generales bg-dorado/20 focus:outline-none focus:textos_generales focus:font-bold focus:bg-verde/20 focus:border-verde transition duration-150 ease-in-out'
