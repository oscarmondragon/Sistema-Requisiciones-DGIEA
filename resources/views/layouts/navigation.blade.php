            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div>
                    @if (Auth::user()->rol == 1 || Auth::user()->rol == 2)
                        <p class="bg-green-100 border-2 border-green-500 rounded-full p-1 px-2 text-sm text-green-700">
                            Administrador
                        </p>
                    @else
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:bg-transparent hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
