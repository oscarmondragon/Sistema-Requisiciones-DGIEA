  ...
  <x-slot name="content">
    <div>
      ...
      <div class="mb-4">
        ...
        <input wire:model="cantidad" wire:change="calcularIvaImporte" required class="inputs_formulario_adquisicion_descripcion" id="cantidad" type="number" min="0" placeholder="Cantidad">
      ...
      <div class="mb-4">
        ...
        <input wire:model="precioUnitario" wire:change="calcularIvaImporte" required class="inputs_formulario_adquisicion_descripcion" id="precioUnitario" type="number" min="0" placeholder="$ Precio unitario">
