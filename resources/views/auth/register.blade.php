<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full input_login" type="password" name="password" required autocomplete="off" placeholder="Contraseña" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full input_login" type="password" name="password_confirmation" required autocomplete="off" placeholder="Confirmar contraseña" />
